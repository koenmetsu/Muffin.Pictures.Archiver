...
[<assembly: AssemblyVersionAttribute("1.4444.0")>]
[<assembly: AssemblyFileVersionAttribute("1.4444.0")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "1.4444.0"
    let [<Literal>] InformationalVersion = "1.4444.0"
